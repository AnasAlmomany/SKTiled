...
@objc public protocol SKTiledSceneCameraDelegate: class {
     ...
     */
    @objc func cameraPositionChanged(newPosition: CGPoint)
     ...
     */
    @objc func cameraBoundsChanged(bounds: CGRect, position: CGPoint, zoom: CGFloat)
     ...
     */
    @objc func sceneDoubleTapped(location: CGPoint)
    #else
     ...
     */
    @objc func sceneDoubleClicked(event: NSEvent)
